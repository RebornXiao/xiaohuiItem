...
<html>
    ...
    <body style="height: auto;width: auto;background-image: url('assets/images/bg.jpg')">


        <div class="wrapper-page">

            <div class="text-center">
                <a href="index.html" class="logo logo-lg"><i class="fa fa-windows"></i> <span>智能超市后台管理系统</span> </a>
            </div>

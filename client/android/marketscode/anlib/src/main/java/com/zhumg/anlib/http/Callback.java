...
public class Callback extends AbsCallback implements Runnable {
    ...
    public static String PASSPORT_ID = null;
    ...
    public Callback(Context context, Map map, String url, boolean post, HttpCallback httpCallback, Dialog dialog) {
        ...
        //添加accessToken
        if(ACCESS_KEY != null) {
            map.put("accessToken", ACCESS_KEY);
        }

        if(PASSPORT_ID != null) {
            map.put("passportId", PASSPORT_ID);
        }
    }
    ...
    public Object convertSuccess(Response response) throws Exception {
        ...
        try {
            ...
            if(json.optString("code").equals("SUCCESS")){
                ...
                try{
                    String str=json.optString("code");
                    httpCallback.code = Integer.parseInt(str);
                }catch (Exception ex){

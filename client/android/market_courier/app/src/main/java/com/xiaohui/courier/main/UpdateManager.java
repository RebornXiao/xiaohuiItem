...
import com.xiaohui.courier.response.VersionInfo;
import com.xiaohui.courier.response.enums.ClientTypeEnum;
import com.xiaohui.courier.response.enums.DeviceTypeEnum;
import com.xiaohui.courier.response.enums.VersionTypeEnum;
        ...
        Http.post(c, map, Api.VERSION_UPGRADE, new HttpCallback<VersionInfo>() {
            ...
            public void onSuccess(VersionInfo data) {
                if(Api.passport != null) {
                    Api.passport.setVersionMessage(data);
                }

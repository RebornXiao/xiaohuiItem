...
import com.xlibao.passport.service.passport.PassportApplicationContextNotify;
...
public class ApplicationContextLoaderNotify {
    ...
    @Autowired
    private PassportApplicationContextNotify passportApplicationContextNotify;

    void applicationContextLoaderNotify() {
        passportApplicationContextNotify.loaderNotify();

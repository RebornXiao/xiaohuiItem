...
public class PrintFEUtils {
	...
	public static String print(String printCode, String printtimes, String content) {
		
		logger.info("printCode:" + printCode + ",printtimes:" + printtimes);
		logger.info("content:" + content);
		
		String printParams[] = printCode.split("\\|");
		...
		try {
			...
			if (statecode == 200) {
				...
				if (httpentity != null) {
					...
					logger.info("打印成功，strentity : " + strentity);
					return strentity;
				} else {
					logger.error("打印失败，httpentity is null ");
					return null;
				}
			} else {
				logger.error("打印失败，statecode : " + statecode);
				return null;
			}
		} catch (Exception e) {
	...
	public static void test( ){
		...
		System.out.println("一一一一一一一一一一一一一一一一一一一一一一一一".length());
	}
	public static void main(String arg[]){
		...
		content += "西红柿鸡蛋炒饭西红柿鸡蛋炒饭西红柿鸡蛋炒饭西红柿鸡蛋炒饭 100.0  10  100.0<BR>";
		content += "备注：加辣<BR>";
		content += "------------------------------------------------<BR>";
		content += "一一一一一一一一一一一一一一一一一一一一一一一一<BR>";
		content += "合计：xx.0元<BR>";
		...
		PrintFEUtils.print("815800445|0RBq9e4S", "1", content);
		test();
